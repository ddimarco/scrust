    ...
    pub fn render(&self,
        ...
        for ty in 0..tiles_y {
            ...
            for tx in 0..tiles_x {
                ...
                self.terrain_info.render_mtxm(mtxm_tile,
                                              trg_buf,
                                              left as i32,
                                              top as i32,
                                              trg_pitch as usize,
    ...
    fn render_mini_tile(&self,
        ...
        for row in 0..8 {
            for col in 0..8 {
                ...
                let outpos = (y + row) as usize * stride + (x + col) as usize;
                let imgpos = (row * 8) + if flipped { 7 - col } else { col };
